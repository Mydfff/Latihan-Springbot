...
//    public void setEmail(String email) { this.email = email; }
    ...
    public String getMobile() { return nama; }

    public void setMobile(String mobile) { this.nama = nama; }

    public String getLastName() { return nama; }

    public void setLastName(String lastName) { this.nama = nama; }
